...
class CountryDetailsViewController: UIViewController {
    ...
    func supportDarkMode(){
        ...
        streetMapButton.setImage(isDarkMode ? UIImage(named: "Group 19") : UIImage(named: "OpenStreetMap"), for: .normal)
        googleMapButton.setImage(isDarkMode ? UIImage(named: "Group 18") : UIImage(named: "GoogleMap"), for: .normal)
